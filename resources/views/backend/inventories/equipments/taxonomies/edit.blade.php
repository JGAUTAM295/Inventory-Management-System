                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group {{ $errors->has('input_field_type') ? 'has-error' : ''}}">
                        ...
                        <select id="input_type" class="form-control custom-select" name="input_field_type">
                          ...
                          <option value="File" @if($taxonomy->input_field_type == 'File') selected @endif>File</option>
                        </select>
                        ...
                        @enderror
                        @php $selected = explode(",", $taxonomy->file_accept) @endphp
                        <div id="FileValid" class="mt-2" @if($taxonomy->input_field_type == 'File') style="display:block" @else style="display:none" @endif>
