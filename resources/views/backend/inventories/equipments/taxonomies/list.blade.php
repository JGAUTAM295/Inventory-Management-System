    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h3>Custom Fields 
               @if(in_array('taxonomy.create', $groupsWithRoles))<a href="{{ route('taxonomy.create') }}"><button class="btn btn-primary">Add Custom Field</button></a>@endif
                ...
                <table id="example1" class="table table-bordered table-striped mt-3">
                  ...
                  <tr>
                    ...
                    <td class="project-actions">
                      @if(in_array('taxonomy.show', $groupsWithRoles))
                          ...
                          @endif
                      @endif
                      @if(in_array('taxonomy.edit', $groupsWithRoles))
                          <a class="btn btn-info btn-sm" href="{{ route('taxonomy.edit', $taxonomy->id) }}">
                              <i class="fas fa-pencil-alt"></i>  Edit
                          </a>
                      @endif
                      @if(in_array('taxonomy.destroy', $groupsWithRoles))
