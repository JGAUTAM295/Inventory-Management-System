                    ...
                    <div class="col-md-12 dynamicDiv">
                      ...
                      @if($cfs)
                        ...
                        <div class="form-group col">
                          ...
                          <input type="file" id="input{{strtolower(str_replace(' ', '_', $cf->name)) ?? ''}}" class="form-control {{strtolower($cf->input_field_type).'css'}}" name="{{$cf->slug.'='.$cf->id ?? ''}}" @if($cf->input_required != "") required @endif>
