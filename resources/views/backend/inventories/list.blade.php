...
@section('content')
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h3>Customer @if(in_array('inventory.create', $groupsWithRoles))<a href="{{ route('inventory.create') }}"><button class="btn btn-primary">Add Customer</button></a>@endif</h3>
          </div>
          <div class="col-sm-6">
                ...
                <table id="example1" class="table table-bordered table-striped mt-3">
                  ...
                  <tr>
                    ...
                    <td class="project-actions">
                      @if(in_array('inventory.show', $groupsWithRoles))
                      ...
                      @endif
                      @if(in_array('inventory.edit', $groupsWithRoles))
                      <a class="btn btn-info btn-sm" href="{{ route('inventory.edit', $inventory->id) }}">
                          <i class="fas fa-pencil-alt"></i>  Edit
                      </a>
                      @endif
                      @if(in_array('inventory.destroy', $groupsWithRoles))
