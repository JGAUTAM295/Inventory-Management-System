...
@section('pagetitle', 'Staff Users List')
...
@section('content')
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h3>Staff Users <a href="{{ route('addUser') }}"><button class="btn btn-primary">Add Staff User</button></a></h3>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{ url('/') }}">Home</a></li>
              <li class="breadcrumb-item active">Staff User</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
...
<script type="text/javascript">
  ...
  $('.show_confirm').click(function(event) {
      ...
      swal({
          title: `Are you sure you want to delete this Staff user?`,
