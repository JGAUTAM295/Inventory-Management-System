          ...
          <div class="card card-primary card-outline">
            <div class="card-body box-profile">
              <div class="text-center">
                @if($user->image)
                <img class="profile-user-img img-fluid img-circle" src="{{asset('/public/image/'.$user->image)}}" alt="User profile picture" style="width: 80px;height: 80px; padding: 10px; margin: 0px; ">
                @endif
