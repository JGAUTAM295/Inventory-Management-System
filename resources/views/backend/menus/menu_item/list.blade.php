...
@section('content')
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h3>Menu Item @if(in_array('menus_item.create', $groupsWithRoles))<a href="{{ route('menus_item.create') }}"><button class="btn btn-primary">Add Menu Item</button></a>@endif</h3>
          </div>
          <div class="col-sm-6">
                ...
                <table id="example1" class="table table-bordered table-striped mt-3">
                  ...
                  <tr>
                    ...
                    <td class="project-actions">
                      @if(in_array('menus_item.edit', $groupsWithRoles))
                      <a class="btn btn-info btn-sm" href="{{ route('menus_item.edit', $menu->id) }}">
                          <i class="fas fa-pencil-alt"></i> Edit
                      </a>
                      @endif
                      @if(in_array('menus_item.destroy', $groupsWithRoles))
                      <form method="POST" action="{{ route('menus_item.destroy', $menu->id) }}" style="display: inline-block;">
                        @csrf
