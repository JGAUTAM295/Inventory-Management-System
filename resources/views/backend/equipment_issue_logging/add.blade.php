...
@section('pagetitle', 'Equipment Issue Add')
...
@section('content')
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h3>Add Equipment Issue <a href="{{ route('equipment_issues.index') }}"><button class="btn btn-primary">Back</button></a></h3>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Equipment Issue Add</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
        ...
        <div class="col-md-12">
          ...
          <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title">Add Equipment Issue Details</h3>
            </div>
            <div class="card-body">
                <form action="{{ route('equipment_issues.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-md-6">
                      ...
                      <div class="form-group {{ $errors->has('scope_of_work') ? 'has-error' : ''}}">
                        ...
                        <textarea id="inputDescription" class="form-control" rows="7" name="scope_of_work" required></textarea>
                        @error('scope_of_work')
                          <span class="invalid-feedback" role="alert" style="display:block;">
                            <strong>{{ $message }}</strong>
                          </span>
                    ...
                    <div class="col-md-6">
                      ...
                      <div class="form-group {{ $errors->has('orderdate') ? 'has-error' : ''}}">
                        <label for="inputOrderdate">Date <span class="text-danger">*</span></label>
      ...
      <div class="row">
        <div class="col-12">
          ...
          <input type="submit" value="Create new equipment issue" class="btn btn-success float-right">
        </div>
      </div>
      </form>
    </section>
