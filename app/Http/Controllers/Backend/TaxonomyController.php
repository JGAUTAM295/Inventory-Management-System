...
class TaxonomyController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('backend.inventories.equipments.taxonomies.list', compact('taxonomies', 'groupsWithRoles'));
    }
    ...
    public function store(Request $request)
    {
        ...
        else
        {
            ...
            {
                $newTaxonomy->file_accept = implode(',', $request->file_accept);
            }
    ...
    public function show(Request $request, Taxonomy  $taxonomy)
    {
        ...
        return view('backend.inventories.equipments.taxonomies.data.list',  [ 'taxonomy' => $taxonomy, 'taxonomiesdata' => $taxonomiesdata, 'groupsWithRoles' => $groupsWithRoles ]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if(!empty($request->file_accept))
        {
            $taxonomy->file_accept = implode(',', $request->file_accept);
        }
