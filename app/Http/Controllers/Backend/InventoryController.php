...
class InventoryController extends Controller
{
    ...
    public function index(Request $request)
    {
        if (Auth::check()) 
        {
            ...
            return view('backend.inventories.list', compact('inventories', 'groupsWithRoles'));
        }
        else
        {
    ...
    public function store(Request $request)
    {
        ...
        else
        {
            ...
            $newInventory->phone = $request->phone;
            $newInventory->address = $request->address;
    ...
    public function show($id)
    {
        ...
        return view('backend.inventories.equipments.list', compact('inventory','equipments', 'groupsWithRoles'));
    }
    ...
    {
        $client = Inventory::where('id',$request->id)->first();
        
       return response() -> json(['status' => 200, 'data' => $client->address]);
    }
}
